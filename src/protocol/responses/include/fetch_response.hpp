...
public:
  ...
  FetchResponse &
  writePartitionData(int32_t partition_index, int16_t error_code, int64_t high_watermark,
  ...
  FetchResponse &
  writeRecordBatches(const std::vector<RecordBatchReader::RecordBatch> &record_batches);
